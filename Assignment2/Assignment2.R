...
ggplot(data, aes(x = Date, y = Moving_Avg_Global_intensity)) +
  geom_line(aes(color = "Average Smoothed Week")) +
  ...
  scale_color_manual(values = c("Average Smoothed Week" = "blue", "Most Anomalous Week" = "red", "Least Anomalous Week" = "green")) +
  labs(title = "Smoothened Weeks Comparison", y = "Global Intensity") +
  theme_minimal()
